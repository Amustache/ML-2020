...
def clustering_training(x, n_clusters, encoder, batch_size, path):
    ...
    model.save_weights(os.path.join(path, 'cluster_weights.h5'))
...
def load_encoder(dims, init, path):
...
if __name__ == "__main__":
    ...
    n_clusters = 2
    batch_size = 256
    cluster_model = clustering_training(x_train, n_clusters, encoder, batch_size, output_path)
